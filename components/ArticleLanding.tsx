...
export default function TripLanding() {
  ...
  return (
    <div className={styles["article-landing"]}>
      <Image src="https://ik.imagekit.io/vicharm/九份/50188569871_7430e1dc46_o_i701rkfVT.jpeg?updatedAt=1637218853301" alt="" className={styles.background} loading="lazy" layout="fill" />
